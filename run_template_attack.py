...
def run_template_attack(m_data_profile, metadata_profile, idx_profile, m_data_attack, 
    ...
    if cmethod == 'sample':
        ...
        curves = get_signal_strength_ssp(results['M'], results['B'], results['W'], nidxp)
        ...
        Spool = results['W'] / (nr_groups * (nidxp - 1))
        A, *_ = compute_params_lda(results['B'], Spool)
        ...
        U, _, xmm, K = compute_params_pca(results['M'], cparams['pca_threshold'],
                                    cparams['pca_alternate'])
    ...
    x_profile = compute_features_e2_mmap(m_data_profile, metadata_profile,
    ...
    x_attack = compute_features_e2_mmap(m_data_attack, metadata_attack,
    ...
    if atype == 'mvn':
        ...
        tmiu, tsigma = compute_template(x_profile) # pare sa nu fie aici
